...
import com.arkadiusz.application.data.service.InvestmentService;
...
//        logoImage.setHeight("25%");
        ...
        info.add(createInfoRow("Nazwa inwestycji", myInvestment.getInvestmentName(), VaadinIcon.HOME),
                ...
                new Hr(),
                createInfoRow("Budżet", String.valueOf(currencyFormat(myInvestment.getInvestmentBudget().setScale(0, RoundingMode.FLOOR))), VaadinIcon.MONEY),
                createEditButton());
...
//        conf.setTooltip(tooltip);
        ...
        column.getDataLabels().setFormatter("function() { return ''+ this.series.name +': '+ this.y +''+' zł';}");
    ...
    private Component configureLastExpenses() {
        ...
        ComponentRenderer<Component, Expense> expenseInfoRenderer = new ComponentRenderer<>(expense -> {
            ...
            Span amount = new Span("Kwota: " + currencyFormat(expense.getAmount()));
