...
public class UploadArea extends VerticalLayout {
    ...
    public UploadArea(File uploadFolder) {
        addClassName("appcontent");
        this.getStyle().set("background-color", "white");

        H4 title = new H4("Udostępnij pliki:");
        ...
        uploadField.setDropLabel(new Label("Przeciągnij plik (max 1MB)"));
        uploadField.setUploadButton(new Button("Udostępnij"));
        ...
        add(title, uploadField, errorField);
    }
