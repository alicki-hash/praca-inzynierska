...
import com.example.application.views.contactList.ContactListView;
...
public class MainLayout extends AppLayout {
    ...
    private void createHeader() {
        Span logo = new Span("Inzynierka DEMO");
...
//        drawer.getElement().getStyle().set("text-transform", "uppercase");
        ...
        tabs.add(
                ...
                createTab(VaadinIcon.PIE_CHART, "Wykres", DashboardView.class, DashboardView.descriptionOfView),
