package com.example.application.views.contactList;

import com.example.application.data.entity.Company;
import com.example.application.data.entity.Contact;
import com.example.application.data.entity.WorkScope;
...
public class ContactFormTest {
    ...
    public void saveEventHasCorrectValues() {
        ...
        form.phone.setValue("123 456 789");
        ...
        Assert.assertEquals("123 456 789", savedContact.getPhone());
